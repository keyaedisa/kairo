...
echo
	...
	echo "################################################################## "
	echo "- Current version number : "$iso_version
	...
	iso_version='$newVersion'

	echo "Version is now: "$iso_version
...
case $input in
	...
	y )
		echo "################################################################## "
		echo "- Enter new iso name"
		echo "################################################################## "
		echo

		read new_iso_name
		oldname1='iso_name="$iso_name'
		newname1='iso_name="$new_iso_name'
		;;
	
	* ) 
		echo "################################################################## "
		echo "- Please type only y for yes and n for no"
		echo "################################################################## " 
		;;	
esac

echo "################################################################## "
echo "- Change iso label? (enter only one --> y or n):"
echo "################################################################## "
echo
...
case $input in
	...
	y )
		echo "################################################################## "
		echo "- Enter new iso label"
		echo "################################################################## "
		echo

		read new_iso_label
		isoLabel=$new_iso_label
		oldname1='iso_label="$iso_label'
		newname1='iso_label="$new_iso_label'
		;;
